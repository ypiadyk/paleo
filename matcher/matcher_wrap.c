...
/*-----------------------------------------------
              @(target):= _matcher_module.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__matcher_module

#else
#  define SWIG_init    init_matcher_module

#endif
#define SWIG_name    "_matcher_module"
...
SWIGINTERN PyObject *_wrap_compute_diffs(PyObject *self, PyObject *args) {
  ...
  {
    array5 = obj_to_array_no_conversion(swig_obj[1], NPY_FLOAT);
